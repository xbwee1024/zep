...
malValuePtr malList::conj(malValueIter argsBegin,
                          malValueIter argsEnd) const
{
    int oldItemCount = (int)std::distance(begin(), end());
    int newItemCount = (int)std::distance(argsBegin, argsEnd);
...
malValuePtr malVector::conj(malValueIter argsBegin,
                            malValueIter argsEnd) const
{
    auto oldItemCount = std::distance(begin(), end());
    auto newItemCount = std::distance(argsBegin, argsEnd);
